...
| 2026-09-02 | b1a0b4ed-db3e-5e71-82ca-c34e1f73ec87 | T-07 | AC-API-6,AC-API-7,AC-API-12,AC-API-10 | 42.5 | 4.1 | 0.10 | 1,936 | 20,384 | 203,653 | 2,031,797 | 5.62 | claude-fable-5-1 100% | 1/0/0 | 27 | pass | typed client + full-jitter retry; MSW draws its own Math.random so the no-random assertion lives in retry.test.ts |
