...
| 2026-09-01 | c6e5e0b7-6bb2-5887-9e12-5278ba684c17 | LEDGER-02 | - | 6.5 | 2.1 | 0.33 | 1,054 | 7,252 | 114,753 | 2,027,756 | 3.18 | claude-fable-5-1 100% | - | - | n/a | add claude-fable-5-1 to the price table (cache read 0.025x); tooling only, no application code |
