...
| 2026-09-01 | c6e5e0b7-6bb2-5887-9e12-5278ba684c17 | LEDGER-02 | - | 7.1 | 2.5 | 0.35 | 1,411 | 9,202 | 124,667 | 2,667,381 | 3.63 | claude-fable-5-1 100% | - | - | n/a | add claude-fable-5-1 to the price table (cache read 0.025x); tooling only, no application code |
