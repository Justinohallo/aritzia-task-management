...
| 2026-09-02 | bde7d8f4-3069-549e-91da-0699f6cedbf5 | T-05 | AC-LIST-1,AC-LIST-2,AC-LIST-3,AC-LIST-4,AC-FILT-1,AC-FILT-2,AC-FILT-3,AC-FILT-4,AC-FILT-5,AC-FILT-6,AC-DONE-1,AC-DONE-2,AC-DONE-3,AC-DEL-1,AC-DEL-3,AC-DEL-4 | 40.8 | 5.6 | 0.14 | 1,994 | 29,357 | 155,126 | 3,822,389 | 5.55 | claude-fable-5-1 100% | 3/1/0 | 24 | pass | T-05 list, filter, complete, delete. Filter held in the URL via next/navigation; tests fake the router hooks and a Chromium run against the production build proved the round trip. A stale local main tripped the ownership check once; refreshed from origin. |
