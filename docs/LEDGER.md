...
| 2026-09-02 | cf4a6035-d6a3-5e26-8fff-f8cb52564466 | T-14 | - | 13.7 | 10.4 | 0.75 | 11,992 | 50,373 | 227,288 | 7,139,787 | 8.97 | claude-fable-5-1 100% | - | 0 | n/a | T-14 presentation: 19 slides in the six-section structure from TASKS.md, one data source (slides.js) rendered two ways, index.html for presenting and a committed .pptx (pptxgenjs, validated, rendered through LibreOffice for visual QA) linked for download. Section 5 quotes LEDGER.md and ACCEPTANCE.md at main fb7e61f; README names the T-15 re-injection. No application code, no tests. Interventions not counted: autonomous cloud session with no operator review before push (ARCH-05 note). qa_result n/a: docs only. |
