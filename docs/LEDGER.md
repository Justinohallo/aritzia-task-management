...
| 2026-09-02 | 5df7031d-8f20-55d1-8d5e-6f0ab58fe727 | T-06 | AC-API-3,AC-API-4,AC-API-5,AC-API-10 | 38.5 | 10.6 | 0.27 | 1,920 | 53,250 | 168,781 | 4,028,189 | 7.06 | claude-fable-5-1 100% | - | 43 | - | T-06 Route Handlers and upstream; merged (#18). Row written from the transcript after merge: /task-close was not run before the PR was merged, so the close turn is not measured here. |
