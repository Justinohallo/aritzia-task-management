...
| 2026-09-01 | c6e5e0b7-6bb2-5887-9e12-5278ba684c17 | LEDGER-02 | - | 11.2 | 5.3 | 0.48 | 3,393 | 17,551 | 147,700 | 7,780,082 | 5.81 | claude-fable-5-1 100% | - | - | n/a | add claude-fable-5-1 to the price table (cache read 0.025x); tooling only, no application code |
